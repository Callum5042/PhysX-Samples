...
{
    float4 diffuse_light_colour = float4(0.6f, 0.6f, 0.6f, 1.0f) * cColour;
    float4 ambient_light_colour = float4(0.1f, 0.1f, 0.1f, 1.0f) * cColour;
    float4 specular_light_colour = float4(0.2f, 0.2f, 0.2f, 1.0f) * cColour;
